...
EXAMPLE_CONF_FILE=${EXAMPLE_CONF_FILE:-$SHARE_EXAMPLES_DIR/vertcoin.conf}
...
then
  ...
  echo -e "To safely generate a vertcoin.conf file, please commit your changes to $BITCOIND, rebuild, then run this script again.\n"
fi

echo 'Generating example vertcoin.conf file in share/examples/'
...
## Generated by contrib/devtools/gen-vertcoin-conf.sh.
##
...
# parse the output from vertcoind --help
