...
<context>
    ...
    <message>
        ...
        <translation type="unfinished">%s пошкоджено. Спробуйте скористатися інструментом гаманця vertcoin-wallet для виправлення або відновлення резервної копії.</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation type="unfinished">%s запитує прослуховування порту %u . Цей порт вважається "поганим", і тому малоймовірно, що будь-які інші вузли Vertcoin Core підключаться до нього. Дивіться doc/p2p-bad-ports.md для отримання детальної інформації та повного списку.</translation>
    </message>
    <message>
...
<context>
    ...
    <message>
        ...
        <translation type="unfinished">Повідомлення, що було додане до vertcoin:URI та буде збережено разом з транзакцією для довідки. Примітка: це повідомлення не буде відправлено в мережу Біткоїн.</translation>
    </message>
</context>
<context>
