...
<context>
    ...
    <message>
        ...
        <translation type="unfinished">%s попытка запуска на порту %u. Этот порт считается "плохим" и маловероятно что узлы Vertcoin Core к нему подключатся. Смотрите дополнительно doc/p2p-bad-ports.md. </translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation type="unfinished">Ошибка загрузки %s: Эта версия программы Vertcoin Core собрана без поддержки функции внешних кошельков </translation>
    </message>
    <message>
