...
<context>
    ...
    <message numerus="yes">
        ...
        <translation><numerusform>%n активное подключение к сети Vertcoin</numerusform><numerusform>%n активных подключения к сети Vertcoin</numerusform><numerusform>%n активных подключений к сети Vertcoin</numerusform><numerusform>%n активных подключений к сети Биткойн</numerusform></translation>
    </message>
    <message>
...
Примечание: Так как комиссия рассчитывается на основе каждого байта, комиссия  "100 сатошей за КБ " для транзакции размером 500 байт (половина 1 КБ) в конечном счете, приведет к сбору только 50 сатошей.</translation>
    ...
    <message>
        ...
        <translation>Creates a Partially Signed Vertcoin Transaction (PSVT) for use with e.g. an offline %1 wallet, or a PSVT-compatible hardware wallet.</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>Please, review your transaction proposal. This will produce a Partially Signed Vertcoin Transaction (PSVT) which you can copy and then sign with e.g. an offline %1 wallet, or a PSVT-compatible hardware wallet.</translation>
    </message>
    <message>
        <source>or</source>
