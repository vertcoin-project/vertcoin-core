...
struct Graph *NewGraph(int64_t index, const std::filesystem::path& targetFile, uint8_t *pk)
{
    uint8_t exists = 0;
    FILE *db;
...
void VerthashDatFile::DeleteMiningDataFile() {
    const std::filesystem::path targetFile{gArgs.GetDataDirNet() / "verthash.dat"};
